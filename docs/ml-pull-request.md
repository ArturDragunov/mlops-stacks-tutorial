...
Links:
* [Staging model in UC](https://dbc-231e176d-b4cc.cloud.databricks.com/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://dbc-231e176d-b4cc.cloud.databricks.com/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
